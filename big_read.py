...
def test_normal_get_chunk(client,size_num,piece,id):
    chunk_id = '/test'+str(size_num)+'M'+piece+'.txt_obj0_chk'+id
...
if __name__ == '__main__':
    ...
    id = sys.argv[3]
    piece = sys.argv[2]
    del sys.argv[1],sys.argv[1],sys.argv[1]
#    t1=time.time()
    client = init()
    test_normal_get_chunk(client,size_num,piece,id)
